...
### Fixed
- Resolve Node 20 action depreciation warning for CI
- Use OIDC for CD

## [3.1.6] - 2026-03-22

### Fixed
- EventSource ignores error events when readyState is CONNECTING
- parseStream responds to AbortSignal immediately
...
### Changed
- GitHub Actions CI enforces Conventional Commits

## [3.1.4] - 2025-10-19

### Changed
- Corrected spelling mistake in README.md
- CD through GitHub Actions uses OIDC to deploy to npm
